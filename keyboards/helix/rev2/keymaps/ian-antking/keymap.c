...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      | Ctl  | Alt  | GUI  |Lower |Space |Space |Raise | Gui  | Left | Down |  Up  | Right|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_COPY, KC_PSTE, KC_LCTL, KC_LALT, KC_LGUI, LOWER, KC_SPC,  KC_SPC,  RAISE,   KC_LGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
